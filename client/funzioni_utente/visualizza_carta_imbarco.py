...
from config import path_visualizza_carta_imbarco as path
from utilities import simula_tempo_attesa, contatta_server, stampa_carta_imbarco
import json


def visualizza_carta_imbarco():
    print("\n\n*** VISUALIZZA CARTA D'IMBARCO ***\n")
    ...
    stringa_1 = "\nI dati inseriti sono validi. Airline Manager sta elaborando la tua richiesta..."
    ...
    if not esito:
        ...
        stampa_carta_imbarco(json.loads(risposta), True)